module Storytime
  class PostPolicy
    ...
    def permitted_attributes
      attrs = [:title, :draft_content, :draft_version_id, :excerpt, :featured_media_id, :featured, :secondary_media_id, :slug, :type_of_header, :published_at_date, :notifications_enabled, :published_at_time, {:tag_list => []}]
